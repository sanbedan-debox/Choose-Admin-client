...
const buttonStyles = {
  [ButtonType.Confirm]:
    "flex items-center justify-center h-10 px-4 py-2 m-1 text-green-600 hover:text-green text-sm border border-green-600 rounded-full transition-colors duration-300 transform hover:bg-green-100  md:w-auto w-32",
  [ButtonType.Icon]:
  ...
  [ButtonType.Warning]:
    "flex items-center justify-center h-10 px-4 py-2 m-1 text-red-500 hover:text-red text-sm border border-red-500 rounded-full transition-colors duration-300 transform hover:bg-red-100 md:w-auto w-32",
};
